...
public class DailyScheduler {
    ...
    public void rodarTarefasDoDia() {
        ...
        if (fechadas > 0 || designadas > 0 || lembretesDeConsulta > 0 || lembretesDeEscala > 0) {
            log.info("Tarefas do dia: {} tarefas fechadas, {} escalas enviadas, {} lembretes de consulta e "
                    + "{} lembretes de formulário", fechadas, designadas, lembretesDeConsulta, lembretesDeEscala);
        }
    }
}
